 ...
 *     <li>通过 {@link JWTParser} 校验签名, 使用荷载中的角色声明构建 {@link SecurityIdentity}</li>
...
public final class JwtAuthenticationMechanism implements HttpAuthenticationMechanism
{
    ...
    public JwtAuthenticationMechanism(@NotNull JWTParser jwtParser, @NotNull TokenService tokenService)
    {
